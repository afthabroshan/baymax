...
class ReminderView extends StatefulWidget {
  ...
  const ReminderView({super.key, required this.selectedDate});
    ...
    return Stack(
      children: [
        BackdropFilter(
          ...
          child: Container(
            color: const Color.fromARGB(255, 80, 115, 255)
                .withAlpha(20), // Optional dark overlay
          ),
        ),
        Center(
          child: Dialog(
            backgroundColor:
                const Color.fromARGB(192, 68, 137, 255).withAlpha(100),
            // elevation: 5,
            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Add your reminders for ${DateFormat.yMd().format(widget.selectedDate)}',
                      style: TextStyle(
                          fontSize: 13.sp,
                    ...
                    ElevatedButton(
                      style: ButtonStyle(
                        backgroundColor: WidgetStateProperty.all(
                            const Color.fromARGB(255, 110, 110,
                                110)), // Set button background color
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          style: ButtonStyle(
                            backgroundColor: WidgetStateProperty.all(
                                const Color.fromARGB(255, 102, 102,
                                    102)), // Set button background color
